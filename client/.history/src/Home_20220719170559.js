            ...
            <div style={{ display: 'flex', width: "100vw", height: "100vh" }}>
                ...
                <div style={{ width: "50vw", height: "100vh", backgroundColor: "blue", marginRight: "1vw" }}>
                    <div style={{ width: "50vw", height: "10vh", backgroundColor: "#00008b" }}>
                        ...
                        <svg style={{width:"20%",height:"50%",marginTop:'2vh',position:"absolute",right:"0"}} xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-plus-circle-fill" viewBox="0 0 16 16">
