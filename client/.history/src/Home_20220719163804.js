        ...
        <>
            <div style={{ display: 'flex', width: "100vw", height: "100vh" }}>
                ...
                <div style={{ width: "50vw", height: "100vh", backgroundColor: "blue", marginRight: "1vw" }}>
                    <div style={{ width: "50vw", height: "10vh", backgroundColor: "dark blue" }}>
                ...
                <div style={{ width: "24vw", height: "100vh", backgroundColor: "red" }}>
                    <div style={{ width: "24vw", height: "10vh", backgroundColor: "dark blue", textAlign: 'center', fontSize: '150%', color: "white", fontWeight: "600", position: "fixed" }}>
                        <p style={{ marginTop: "2vh" }}>
                            Records
                        </p>
                    </div>
