        ...
        <>
            <div style={{ display: 'flex', width: "100vw", height: "100vh", backgroundColor: "#8f9091" }}>
                ...
                <div style={{ width: "24vw", height: "100vh", backgroundColor: "blue" }}>
                    ...
                    <div style={{ display:'inline-block',maxWidth: "22.5vw", height: "40vh", backgroundColor: "#00008b", textAlign: 'center', fontSize: '150%', color: "white", fontWeight: "600", zIndex: "2", overflowY: "scroll", overflowX: "hidden" }}>
                        {personName && personName.map((user) => (
                            user.length > 0 && <div style={{ width: "23vw", backgroundColor: "black", color: "white", height: "3vh", fontSize: "2vh", position: 'relative', borderBottom: '1px solid white' }}>
                                {user}
