...
const Home = () => {
    ...
    function colorPlace() {
        changeColorPlace(document.getElementById('textField'), placeName);
    }
    useEffect(() => {
        if (personName) {
            colorName();
    ...
    function colorName() {
        changeColorName(document.getElementById('textField'), personName);
    }
    function clickPerson(){
        console.log(document.getElementsByClassName("colorName"));
        document.getElementsByClassName("colorName").style.backgroundColor="red";
    }
    function clickOrg(){
        document.getElementsByClassName("colorPlace").style.backgroundColor="blue";
    }
    const changeColorName = (a, b) => a.innerHTML = a.innerHTML.replace(b, `<span class="colorName" style="backgroundcolor:blue;" >${b}</span>`);
    const changeColorPlace = (a, b) => a.innerHTML = a.innerHTML.replace(b, `<span class="colorPlace" style="backgroundcolor:red;">${b}</span>`);
        ...
        <>
            ...
            <div style={{ display: 'flex', width: "100vw", height: "100vh", backgroundColor: "#8f9091", overflow: "hidden" }}>
                <div id="left_component" style={{ display: 'inline', width: "24vw", height: "100vh", backgroundColor: "white", marginRight: "1vw" }}>
                    ...
                    <div style={{ width: "24vw", height: "10vh", backgroundColor: "black", overflow: "hidden", color: "white", fontSize: "120%", display: "flex", justifyContent: 'center', alignItems: 'center', borderBottom: "1px solid white" }}>
                        <span style={{ top: "10vh" }}>
                            1
                        </span>
                ...
                <div style={{ width: leftClose && rightClose ? "100vw" : rightClose ? "75vw" : leftClose ? "75vw" : "50vw", height: "100vh", backgroundColor: "white", marginRight: "1vw", overflowY: "unset" }}>
                    <div style={{ width: leftClose && rightClose ? "100vw" : rightClose ? "75vw" : leftClose ? "75vw" : "50vw", height: "10vh", backgroundColor: "#00008b", position: 'relative', overflowY: 'hidden' }}>
                        ...
                        <div class="btn-group" style={{ marginTop: "1.5vh", marginLeft: "15vw" }}>
                            <button onClick={()=>{clickPerson()}} type="button" class="btn btn-primary" style={{ marginRight: "1vw" }}>Person</button>
                            <button onClick={()=>{clickOrg()}} type="button" class="btn btn-primary">Organization</button>
                        </div>
                        <label for="file">
                    ...
                    <div id="textField" style={{ width: leftClose && rightClose ? "98vw" : rightClose ? "73vw" : leftClose ? "73vw" : "48vw", height: "85vh", marginLeft: "2vw", marginTop: "5vh", overflowY: "scroll" }}>
                        {textField}
                    </div>
                </div>
