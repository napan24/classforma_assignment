...
const Home = () => {
    ...
    const trending = async () => {
        const response = await fetch('/', {
            ...
            body:{'text':"Spain's stricken Bankia expects to sell off its vast portfolio of industrial holdings that includes a stake in the parent company of British Airways and Iberia.",'extractors':'entities','x-textrazor-key':'f5ba4f200d5b759c8ba29d9e3fcc3052ca4ece0f49dae81c4eafd0fe'}
        })
