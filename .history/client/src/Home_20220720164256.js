...
const Home = () => {
    ...
    return (
        <>
            <div style={{ height: "30vh", width: "35vw", backgroundColor: "white", position: "absolute", zIndex: '2', left: "35%", top: "25%", border: "2px solid red" }}>
                <button type="button" class="btn btn-primary" style={{ marginRight: "1vw",position:"absolute",bottom:"10%",left:"25%",padding:"2vh" }}>Cancel</button>
