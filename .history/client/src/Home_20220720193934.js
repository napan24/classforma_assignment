...
const Home = () => {
    ...
    function clickPerson(){
        console.log(document.getElementsByClassName("colorName")[1]);
    ...
    const changeColorName = (a, b) => a.innerHTML = a.innerHTML.replace(b, `<span className="colorName">${b}</span>`);
    const changeColorPlace = (a, b) => a.innerHTML = a.innerHTML.replace(b, `<span className="colorPlace">${b}</span>`);
