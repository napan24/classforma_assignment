        ...
        <>
            <div style={{ display: 'flex', width: "100vw", height: "100vh", backgroundColor: "#8f9091" }}>
                ...
                <div style={{ width: "24vw", height: "100vh", backgroundColor: "blue" }}>
                    ...
                    <div style={{ width: "24vw", height: "48vh", backgroundColor: "#00008b", textAlign: 'center', fontSize: '150%', color: "white", fontWeight: "600", zIndex:"2", overflowY: "scroll" }}>
                        {personName && personName.map((user) => (
                            <div style={{ width: "23vw",backgroundColor: "black", color: "white", height: "3vh",fontSize:"1vh",borderBottom:'1px solid white' }}>
                                {user}
                            </div>
                        ))}
                    </div>
                    ...
                    <div style={{ width: "24vw", height: "50vh", backgroundColor: "#00008b", textAlign: 'center', fontSize: '150%', color: "white", fontWeight: "600", position: "fixed", overflowY: "scroll" }}>
                        {placeName && placeName.map((user) => (
                            <div style={{ width: "23vw", height: '2vh', backgroundColor: "black", color: "white", fontSize: "50%" }}>
                                {user}
                            </div>
                        ))}
                    </div>
