        ...
        <>
            <div style={{ display: 'flex', width: "100vw", height: "100vh", backgroundColor: "#8f9091" }}>
                ...
                <div style={{ width: "24vw", height: "100vh", backgroundColor: "blue" }}>
                    ...
                    <div style={{ width: "24vw", height: "48vh", backgroundColor: "#00008b", textAlign: 'center', fontSize: '150%', color: "white", fontWeight: "600", zIndex:"2",position: "fixed", overflowY: "scroll" }}>
                        {personName && personName.map((user) => (
                            <div style={{ width: "23vw",backgroundColor: "black", color: "white", fontSize: "2vh" }}>
                                {user}
                            </div>
                        ))}
                    </div>
