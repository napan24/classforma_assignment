        ...
        <>
            <div style={{ display: 'flex', width: "100vw", height: "100vh", backgroundColor: "#8f9091",overflow:"hidden" }}>
                ...
                <div style={{ width: "24vw", height: "100vh", backgroundColor: "white" }}>
                    <div style={{ width: "24vw", height: "10vh", backgroundColor: "white", textAlign: 'center', fontSize: '150%', color: "white", fontWeight: "600" }}>
                        <p>
                            Annotations
                        </p>
                    </div>
                    ...
                    <div style={{maxWidth: "24vw", height: "40vh", backgroundColor: "#00008b", textAlign: 'center', fontSize: '150%', color: "white", fontWeight: "600", zIndex: "2", overflowY: "scroll", overflowX: "hidden" }}>
