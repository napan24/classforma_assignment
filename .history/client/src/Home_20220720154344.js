    ...
    return (
        <>
            <div style={{ display: 'flex', width: "100vw", height: "100vh", backgroundColor: "#8f9091" }}>
                ...
                <div style={{ width: "22.7vw", height: "100vh", backgroundColor: "blue" }}>
                    <div style={{ width: "22.7vw", height: "10vh", backgroundColor: "#00008b", textAlign: 'center', fontSize: '150%', color: "white", fontWeight: "600" }}>
                        <p>
                            Annotations
                        </p>
                    </div>
                    <div style={{ width: "22.7vw", height: "5vh", backgroundColor: "#00008b", textAlign: 'center', fontSize: '150%', color: "white", fontWeight: "600" }}>
                        <p>
                            Person
                        </p>
                    </div>
                    <div style={{ display:'inline-block',maxWidth: "22.7vw", height: "40vh", backgroundColor: "#00008b", textAlign: 'center', fontSize: '150%', color: "white", fontWeight: "600", zIndex: "2", overflowY: "scroll", overflowX: "hidden" }}>
                        {personName && personName.map((user) => (
                            user.length > 0 && <div style={{ width: "22.7vw", backgroundColor: "black", color: "white", height: "3vh", fontSize: "2vh", position: 'relative', borderBottom: '1px solid white' }}>
                                {user}
                                <svg xmlns="http://www.w3.org/2000/svg" style={{ width: "3.5vw", height: "3.5vh", position: 'absolute', right: "0" }} fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
                    ...
                    <div style={{ width: "22.7vw", height: "40vh", backgroundColor: "#00008b", textAlign: 'center', fontSize: '150%', color: "white", fontWeight: "600", overflowY: "scroll" }}>
                        {placeName && placeName.map((user) => (
                            user.length > 0 && <div style={{ width: "22.7vw", backgroundColor: "black", color: "white", height: "3vh", fontSize: "2vh", borderBottom: '1px solid white', overflowX: "hidden" }}>
                                {user}
                                <svg xmlns="http://www.w3.org/2000/svg" style={{ width: "3.5vw", height: "3.5vh", position: 'absolute', right: "0" }} fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
                                    <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z" />
                                </svg>
