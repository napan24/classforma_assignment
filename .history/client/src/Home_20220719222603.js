...
const Home = () => {
    ...
    const trending = async () => {
        const response = await fetch('http://api.textrazor.com/', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8'
            },
            body:new URLSearchParams({'text':textField,'extractors':'entities','x-textrazor-key':'f5ba4f200d5b759c8ba29d9e3fcc3052ca4ece0f49dae81c4eafd0fe'}),
            mode: 'no-cors'
        })
