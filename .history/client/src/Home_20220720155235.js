                ...
                <div style={{ width: "24vw", height: "100vh", backgroundColor: "white" }}>
                    ...
                    <div style={{maxWidth: "24vw", height: "40vh", backgroundColor: "white", textAlign: 'center', fontSize: '150%', color: "black", fontWeight: "600", zIndex: "2", overflowY: "scroll", overflowX: "hidden" }}>
                        {personName && personName.map((user) => (
                            user.length > 0 && <div style={{ width: "24vw", backgroundColor: "black", color: "white", height: "3vh", fontSize: "2vh", position: 'relative', borderBottom: '1px solid white' }} value={user}>
                                {user}
                                <svg onClick={(e)=>{replace(e)}} xmlns="http://www.w3.org/2000/svg" style={{ width: "3.5vw", height: "3.5vh", position: 'absolute', right: "0" }} fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
