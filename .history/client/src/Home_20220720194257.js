...
const Home = () => {
    ...
    const changeColorName = (a, b) => a.innerHTML = a.innerHTML.replace(b, `<span class="colorName">${b}</span>`);
    const changeColorPlace = (a, b) => a.innerHTML = a.innerHTML.replace(b, `<span class="colorPlace">${b}</span>`);
