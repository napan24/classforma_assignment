...
const Home = () => {
    ...
    const changeColorName = (a, b) => a.innerHTML = a.innerHTML.replace(b, `<span style="background-color:blue;">${b}</span>`);
    const changeColorPlace = (a, b) => a.innerHTML = a.innerHTML.replace(b, `<span style="background-color:red;>${b}</span>`);
