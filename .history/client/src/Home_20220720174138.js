...
const Home = () => {
    ...
    function showLeftComponent() {
        if (document.getElementById('left_component').style.display == "inline-block") {
            document.getElementById('left_component').style.display = "none";
        }
        else {
            document.getElementById('left_component').style.display = "inline-block";
        }
    ...
    return (
        <>
            ...
            <div style={{ display: 'flex', width: "100vw", height: "100vh", backgroundColor: "#8f9091", overflow: "hidden" }}>
                <div id="left_component" style={{ display:'inline-block',width: "24vw", height: "100vh", backgroundColor: "white", marginRight: "1vw" }}>
                    ...
                    <svg onClick={showLeftComponent()} style={{ width: "5vw", height: "5vh", position: 'absolute', left: "1vw", top: "2.5vh",color:'white' }} xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
                ...
                <div style={{ width: "24vw", height: "100vh", backgroundColor: "white" }}>
                    ...
                    <svg style={{ width: "5vw", height: "5vh", position: 'absolute', right: "0vw", top: "2vh",color:'white' }} xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
                        <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z" />
                    </svg>
                </div>
            </div>
