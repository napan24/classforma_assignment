        ...
        <>
            ...
            <div style={{ display: 'flex', width: "100vw", height: "100vh", backgroundColor: "#8f9091", overflow: "hidden" }}>
                <div id="left_component" style={{ display: 'inline', width: "24vw", height: "100vh", backgroundColor: "white", marginRight: "1vw" }}>
                    ...
                    <div style={{ width: "22vw", height: "10vh", backgroundColor: "black",overflow:"hidden",color:"white",fontSize:"120%",display:"flex",justifyContent:'center',alignItems:'center',borderBottom:"1px solid white" }}>
                        <span style={{top:"10vh"}}>
                            1
                        </span>
                        <span style={{marginLeft:"2vw"}}>
