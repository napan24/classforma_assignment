    ...
    return (
        <>
            ...
            <div style={{ display: 'flex', width: "100vw", height: "100vh", backgroundColor: "#8f9091", overflow: "hidden" }}>
                ...
                <Right_section showRightComponent={showRightComponent} personName={personName} CloseClick={CloseClick} placeName={placeName} CloseClick={CloseClick}></Right_section>
            </div>
        </>
    )
}
