    ...
    return (
        <>
            <div style={{ height: "50vh", width: "35vw", backgroundColor: "white", position: "absolute", zIndex: '2', left: "35%", top: "25%", border: "2px solid red" }}>
                <button type="button" class="btn btn-primary" style={{ marginRight: "1vw",position:"absolute",bottom:"10%",left:"20%",padding:"2vh" }}>Person</button>
                <button style={{ marginRight: "1vw",position:"absolute",bottom:"10%",left:"20%",padding:"2vh" }} type="button" class="btn btn-primary">Organization</button>
            </div>
