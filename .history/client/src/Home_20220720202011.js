...
const Home = () => {
    ...
    const changeColorName = (a, b) => a.innerHTML = a.innerHTML.replace(b, `<span style="background-color:blue;color:white;">${b}</span>`);
    const changeColorPlace = (a, b) => a.innerHTML = a.innerHTML.replace(b, `<span style="background-color:red;color:white;>${b}</span>`);
