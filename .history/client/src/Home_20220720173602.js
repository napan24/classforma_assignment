        ...
        <>
            ...
            <div style={{ display: 'flex', width: "100vw", height: "100vh", backgroundColor: "#8f9091", overflow: "hidden" }}>
                <div style={{ width: "24vw", height: "100vh", backgroundColor: "white", marginRight: "1vw" }}>
                    ...
                    <svg style={{ width: "5vw", height: "5vh", position: 'absolute', left: "1vw", top: "2.5vh",color:'white' }} xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
