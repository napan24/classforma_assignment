...
const Home = () => {
    ...
    function replace(e) {
        ...
        console.log(e.currentTarget.parentElement.querySelector('.userName'));
        console.log(e.currentTarget.parentElement.querySelector('.userName').innerHTML);
        var parent = e.target.parentElement;
        var span = parent.querySelector('.userName');
    }
    return (
        <>
            <div style={{ display: 'flex', width: "100vw", height: "100vh", backgroundColor: "#8f9091", overflow: "hidden" }}>
                ...
                <div style={{ width: "24vw", height: "100vh", backgroundColor: "white" }}>
                    ...
                    <div style={{ width: "24vw", height: "5vh", backgroundColor: "white", textAlign: 'center', fontSize: '150%', color: "black", fontWeight: "600" }}>
                        <p>
                            Person
                        </p>
                    </div>
                    <div style={{ maxWidth: "24vw", height: "40vh", backgroundColor: "white", textAlign: 'center', fontSize: '150%', color: "black", fontWeight: "600", zIndex: "2", overflowY: "scroll", overflowX: "hidden" }}>
                        {personName && personName.map((user) => (
                            user.length > 0 && <div style={{ width: "24vw", backgroundColor: "black", color: "white", height: "3vh", fontSize: "2vh", position: 'relative', borderBottom: '1px solid white' }}>
                                <span className='userName' style={{ width: "12vw" }}>
                                    {user}
                                </span>
                                <button onClick={(e) => { replace(e) }} style={{ width: "2vw", height: "2vh", position: 'absolute', right: "2vw", top: "-0.5vh" ,backgroundColor:'transparent'}} >
                                    <svg xmlns="http://www.w3.org/2000/svg" style={{height:"3vh",width:"2vw",color:'red'}} fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
                    ...
                    <div style={{ width: "24vw", height: "40vh", backgroundColor: "white", textAlign: 'center', fontSize: '150%', color: "black", fontWeight: "600", overflowY: "scroll" }}>
                        {placeName && placeName.map((user) => (
                            user.length > 0 && <div style={{ width: "24vw", backgroundColor: "black", color: "white", height: "3vh", fontSize: "2vh", borderBottom: '1px solid white', overflowX: "hidden" }}>
                                {user}
