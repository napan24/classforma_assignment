...
const Home = () => {
    ...
    const changeColorName = (a, b) => a.innerHTML = a.innerHTML.replace(b, `<span class="colorName" style="color:blue;">${b}</span>`);
    const changeColorPlace = (a, b) => a.innerHTML = a.innerHTML.replace(b, `<span class="colorPlace" style="color:red;">${b}</span>`);
