...
const Home = () => {
    ...
    return (
        <>
            <div style={{ height: "50vh", width: "35vw", backgroundColor: "white", position: "relative", zIndex: '2', left: "35%", top: "25%", border: "2px solid red" }}>
                <button type="button" class="btn btn-primary" style={{ marginRight: "1vw",position:"absolute" }}>Person</button>
