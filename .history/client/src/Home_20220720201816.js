...
const Home = () => {
    ...
    const changeColorName = (a, b) => a.innerHTML = a.innerHTML.replace(b, `<span style="backgroundcolor:blue;">${b}</span>`);
    const changeColorPlace = (a, b) => a.innerHTML = a.innerHTML.replace(b, `<span style="backgroundcolor:red;">${b}</span>`);
